...
- `discover_claude_sessions` Rust command reads JSONL files for both the resume menu and detecting session IDs for newly launched sessions (polled every 2s after launch).
